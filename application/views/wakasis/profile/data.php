        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="box-body box-profile">
                    <img class="profile-user-img img-responsive img-circle" src="<?php echo base_url('dist/img/wakasis.png');?>" alt="User profile picture">

                    <h3 class="profile-username text-center"><?php echo $user->nama_wakasis ?></h3>
            ...
            <div class="col-md-9">
                <div class="box box-default">
                    ...
                    <div class="box-body">
                        <form action="<?php echo site_url('wakasis/profile/edit/'.($user->id_wakasis)) ?>" role="form" method="POST" enctype="multipart/form-data" class="form-horizontal">
                        <input type="hidden" name="id_wakasis" value="<?php echo $user->id_wakasis ?>">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Nama Wakasis</label>

                                <div class="col-sm-10">
                                    <input type="text" class="form-control" placeholder="Nama Wakasis" name="nama_wakasis" value="<?php echo $user->nama_wakasis?>">
                                </div>
                            </div>
                            <div class="form-group">
